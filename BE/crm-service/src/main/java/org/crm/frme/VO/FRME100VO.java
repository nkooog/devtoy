...
public class FRME100VO {
    ...
    public String getDataFrmeTmplCd() {
        return dataFrmeTmplCd;
    }

    public void setDataFrmeTmplCd(String dataFrmeTmplCd) {
        this.dataFrmeTmplCd = dataFrmeTmplCd;
    }
